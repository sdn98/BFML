...
data = pd.read_csv("..\..\data\students_grades\student-mat.csv", sep=";")
...
# source:https://github.com/stefanostsolos/Student-Grade-Prediction/blob/master/LinearRegressionStudents.py