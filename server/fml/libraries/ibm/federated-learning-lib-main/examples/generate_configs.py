...
import json
import sys
sys.path.insert(0, 'C:\\Users\\ahmed.saidani\\Desktop\\FMLB\\server\\fml\\libraries\\ibm\\federated-learning-lib-main\\examples\\fedavg')
...
from constants import GENERATE_CONFIG_DESC, NUM_PARTIES_DESC, \
...
from constants import FL_CONTEXT
...
if __name__ == '__main__':
    ...
    if context_path is not None and context_path != 'None':
        ...
        config_fusion = import_module('{}.generate_configs'.format(fusion))
